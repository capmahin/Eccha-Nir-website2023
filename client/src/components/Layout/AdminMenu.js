...
const AdminMenu = () => {
  ...
  <NavLink to="/dashboard/admin/create-latestproduct" className="list-group-item list-group-item-action bg-success">Create LatestProduct</NavLink>
  ...
  <NavLink to="/dashboard/admin/latestproducts" className="list-group-item list-group-item-action bg-success">Latest Products</NavLink>
